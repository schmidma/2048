...
2048: src/main.c src/move.c src/highscore.c src/init.c src/update.c
	...
	$(CC) -o bin/2048 obj/main.o obj/move.o obj/highscore.o obj/init.o obj/update.o $(INCLUDE_MAC) $(FRAMEWORK_MAC)
...
2048.exe: src/main.c src/move.c
	...
	$(CC) -o bin/2048.exe obj/main.o obj/move.o obj/highscore.o obj/init.o obj/update.o $(FLAGS_WIN)
